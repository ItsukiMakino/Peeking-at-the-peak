...
{
    public class MenuStateObsolete : BaseStateComponent
    {
        ...
        [Inject]
        public void Constructer(PlayerInput playerInput, PlayerBehaiviour _playerComponets, LoadUISystem loadUiSystem, PageContainer pageContainer
        ...
        {
            var value = playerInput.MyAction.UI.Back.ReadValue<float>();
            if (value == 1)
            {
        ...
        public bool ToPose()
        {
            ...
            if (!SaveSystem.loadData.Poseing && playerInput.MyAction.UI.Back.IsPressed())
                return true;
            return false;
        }
        public bool ToPlay()
